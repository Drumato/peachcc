...
static Token *c_keyword(char *ptr)
{
    char *keywords[] = {"return", "if", "else", "for", "while", "int", "sizeof", "char", "static", "extern", "struct", "void", NULL};
    TokenKind kinds[] = {TK_RETURN, TK_IF, TK_ELSE, TK_FOR, TK_WHILE, TK_INT, TK_SIZEOF, TK_CHAR, TK_STATIC, TK_EXTERN, TK_STRUCT, TK_VOID};
